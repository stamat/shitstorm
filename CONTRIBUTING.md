# Contributing to Shitstorm

Issues and pull requests are welcome.

Shitstorm is the starting point for a [Poops](https://github.com/stamat/poops)
project: `poops.json`, a `src/` laid out the way Poops expects, and the smallest
set of dependencies that gets you a built site. That last part is the design —
whatever lands here, everyone who scaffolds from this template carries. A change
that adds a dependency needs to argue for itself.

## Getting set up

```bash
git clone https://github.com/stamat/shitstorm.git
cd shitstorm
npm install
```
